...
class FavoriteDetailsScreen extends StatefulWidget {
  ...
  @override
  State<FavoriteDetailsScreen> createState() => _FavoritDetailsScreenState();
}

class _FavoritDetailsScreenState extends State<FavoriteDetailsScreen> {
  bool isExpanded = false;

  @override
  Widget build(BuildContext context) {
    final cart = widget.favorite;
