  ...
  static Route<void> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      case StringRoute.onBoarding:
        return BaseRoute(page: const OnboardingScreen(), transitionType: RouteTransitionType.fade);
      ...
      case StringRoute.signin:
        return BaseRoute(page: SignInScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.signUp:
        return BaseRoute(page: SignUpScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.forget:
        return BaseRoute(page: ForgotPasswordScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.forget2:
        return BaseRoute(page: ForgotPasswordEmailScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.verfication:
        return BaseRoute(page: VerificationCodeScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.verfication2:
        final args = settings.arguments;
        if (args != null && args is String) {
          return BaseRoute(page: VerificationemailScreen(email: args), transitionType: RouteTransitionType.fade);
        } else {
          return BaseRoute(
            page: const Scaffold(body: Center(child: Text('Email not provided!'))),
            transitionType: RouteTransitionType.fade,
          );
        }

      case StringRoute.congrate:
        return BaseRoute(page: CongrateScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.createnewPassword:
        final args = settings.arguments;
        if (args != null && args is String) {
          return BaseRoute(page: CreateNewPassword(email: args), transitionType: RouteTransitionType.fade);
        } else {
          return BaseRoute(
            page: const Scaffold(body: Center(child: Text('Email not provided!'))),
            transitionType: RouteTransitionType.fade,
      ...
      case StringRoute.home:
        return BaseRoute(page: HomeScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.productlist:
        return BaseRoute(page: ProductListScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.search:
        return BaseRoute(page: SearchScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.bottomBar:
        return BaseRoute(page: BottomBar(), transitionType: RouteTransitionType.fade);

     

      case StringRoute.popularProduct:
        return BaseRoute(page: PopularProductScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.favorite:
        return BaseRoute(page: FavoriteScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.category:
        return BaseRoute(page: CategoryScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.brands:
        return BaseRoute(page: BrandsScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.cart:
        return BaseRoute(page: ProductCartScreen(), transitionType: RouteTransitionType.fade);

      case StringRoute.productDetails:
        return BaseRoute(page:  ProductDetailsScreen(), transitionType: RouteTransitionType.fade);
      case StringRoute.profile:
        return BaseRoute(page:  ProfileScreen(), transitionType: RouteTransitionType.fade);
